...
public class Base64 {
	...
	public static String encode(String str, String charset)
		...
		byte[] encoded = encodeBytesToBytes(bytes);
		try {
	...
	public static String encodeString(String str) throws RuntimeException {
	...
	public static String decodeString(String str) throws RuntimeException,
			IOException {
		byte[] bytes;
		try {
			bytes = str.getBytes("ASCII");
